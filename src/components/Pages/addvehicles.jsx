        ...
        <form onSubmit={handleSubmit} className='carForm'>
          ...
          <div className='angaben'>
            <div className='selectDiv'>
              ...
              <select value={fahrzeugart} onChange={(e) => setFahrzeugart(e.target.value)} className='select'>
            ...
            <input type='number' placeholder='Nächster Ölwechsel bei Km' value={nächsteoelwechselKm} onChange={(e) => setNächsteoelwechselKm(e.target.value)} />
